    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 10), // Icon aligned to left
          ...
          Linkbuttons(imagePath: appIcons.google, text: 'Continue with Google', onTap:(){}),
          Linkbuttons(imagePath: appIcons.apple, text:'Continue with Apple', onTap: (){}),
