    ...
    return Scaffold(backgroundColor: appColors.whiteBG,
      ...
      body: SingleChildScrollView(
        ...
        IconButton(onPressed: (){}, icon: Icon(Icons.arrow_forward_ios)),
              ...
              SizedBox(height: 20.h,),
              ProfileDetails(icon: Icons.person_outline_rounded, text:'Personal Information', onTap: () {  },),
              ProfileDetails(icon: Icons.security, text:'Login and Security', onTap: () {  },),
              ProfileDetails(icon: Icons.payments_outlined, text:'Payments and payouts', onTap: () {  },),
              ProfileDetails(icon: Icons.settings_applications_outlined, text:'Accessibility', onTap: () {  },),
              ProfileDetails(icon: Icons.copy_rounded, text:'Taxes', onTap: () {  },),
              ProfileDetails(icon: Icons.g_translate, text:'Translation', onTap: () {  },),
              ProfileDetails(icon: Icons.notifications_outlined, text:'Notifications', onTap: () {  },),
              ProfileDetails(icon: Icons.lock_outline, text:'Privacy and Sharing', onTap: () {  },),
              ProfileDetails(icon: Icons.card_travel, text:'Travel for work', onTap: () {  },),
              SizedBox(height:15.h),
              Primarytext(text: 'Hosting', fontSize:20.sp, fontWeight:FontWeight.w500, textColor:appColors.blacktext),
              SizedBox(height: 20.h,),
              ProfileDetails(icon: Icons.home_outlined, text: 'List your space', onTap: () {  },),
              ProfileDetails(icon: Icons.add_home_rounded, text:'Learn about hosting', onTap: () {  },),
              ProfileDetails(icon: Icons.groups_outlined, text:'Host an experience', onTap: () {  },),
              SizedBox(height:15.h),
              Primarytext(text: 'Support', fontSize:20.sp, fontWeight:FontWeight.w500, textColor:appColors.blacktext),
              SizedBox(height: 20.h,),
              ProfileDetails(icon: Icons.question_mark, text: 'Visit help Center', onTap: () {  },),
              ProfileDetails(icon: Icons.health_and_safety_outlined, text:'Get the help with a security issue', onTap: () {  },),
              ProfileDetails(icon: Icons.mode_of_travel_outlined, text: 'How Airbnb works', onTap: () {  },),
              ProfileDetails(icon: Icons.edit_outlined, text:'Give us feedback', onTap: () {  },),
              SizedBox(height:15.h),
              Primarytext(text: 'Legal', fontSize:20.sp, fontWeight:FontWeight.w500, textColor:appColors.blacktext),
              SizedBox(height: 20.h,),
              ProfileDetails(icon: Icons.menu_book_outlined, text:'Terms of services', onTap: () {  },),
              ProfileDetails(icon: Icons.menu_book_outlined, text:'Privacy Policy', onTap: () {  },),
              ProfileDetails(icon: Icons.menu_book_outlined, text:'Open source licenses', onTap: () {  },),
              SizedBox(height: 8.h,),
